...
BOOL CArchipelago::Initialise(std::string URI) {
	...
	ap->set_slot_connected_handler([](const json& data) {
		...
		//Mandatory values
		if (!data.contains("locationsId") || !data.contains("locationsAddress") || !data.contains("locationsTarget") 
			|| !data.contains("itemsId") || !data.contains("itemsAddress") || !data.contains("base_id") 
		...
		/*
		TODO Implement options to game
